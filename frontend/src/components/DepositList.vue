...
const getAllDeposit = function () {
  axios({
    method: 'get',
    url: `${userStore.API_URL}/fin_ins/deposit_list/`
  })
    .then((res) => {
...
const clickBank = function () {
  if (selectedBank.value === '전체 보기') {
    ...
    axios({
      method: 'get',
      url: `${userStore.API_URL}/fin_ins/get_bank_deposit/${selectedBank.value}/`
    })
      .then((res) => {
        deposits.value = []
        const results = res.data
...
const getDeposit = function () {
  axios({
    method: 'get',
    url: `${userStore.API_URL}/fin_ins/deposit_list/${selectedDepositCode.value}/`
  })
    .then((res) => {
      const data = res.data
...
const addDepositUser = function () {
  axios({
    method: 'post',
    url: `${userStore.API_URL}/fin_ins/deposit_list/${selectedDepositCode.value}/contract/`,
    headers: {
